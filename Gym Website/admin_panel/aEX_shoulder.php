...
<body style="background-color:#666666;">
  ...
  <div id="wrapper">
    ...
    <div class="exerciseshoulder-container">
      <div class="exerciseshoulder-form">
        <h1>Exercise Shoulder Videos</h1>
        ...
        if (isset($_POST['add'])) {
          ...
          $qry = "INSERT INTO exerciseshoulder (title, description, video_url) 
